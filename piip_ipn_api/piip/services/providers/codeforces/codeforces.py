...
class Codeforces:
    ...
    def submit(self, problem, code):
        ...
        url = (
            "https://codeforces.com/problemset/submit?csrf_token="
            + re.findall(csrf_token_pattern, result.text)[0]
        )
        ...
        submissionUrl = (
            ...
            + re.findall(submission_id_pattern, result2.text)[0]
        )
        return {"status": "success", "msg": submissionUrl}
