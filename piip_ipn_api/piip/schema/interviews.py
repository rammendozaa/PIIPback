...
class InterviewSchema(BaseSchema):
    ...
    chosen_date = fields.DateTime(
        data_key="chosenDate", required=False, allow_none=True
    )
    interview_url = fields.String(
        data_key="interviewUrl", required=False, allow_none=True
    )
    interview_code = fields.String(
        data_key="interviewCode", required=False, allow_none=True
    )
    ...
    administrator_id = fields.Integer(
        data_key="administratorId", required=False, allow_none=True
    )
    language_id = fields.Integer(data_key="languageId", required=False, allow_none=True)
    is_confirmed = fields.Boolean(
        data_key="isConfirmed", missing=False, required=False, allow_none=True
    )
